...
public class FsShellHDFSCatActor extends AbstractAFluxActor{
	public FsShellHDFSCatActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		String result=this.getFluxEnvironment().getFsShell().cat(sourceFileName).toString();
