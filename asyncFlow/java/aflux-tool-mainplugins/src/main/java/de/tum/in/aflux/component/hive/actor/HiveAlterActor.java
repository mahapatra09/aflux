...
public class HiveAlterActor  extends AbstractAFluxActor{
	private final Logger log = LoggerFactory.getLogger(this.getClass());	
	
	public HiveAlterActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		// build sentence
		String sentence = "ALTER TABLE  ";
		String name = this.getProperty(HiveConstants.NAME);
		sentence+=" "+name;
		sentence+=" "+this.getProperty(HiveConstants.ALTER_CLAUSE);;
		
		HiveBuilder.deliverPlan("alter",sentence,name,log,executionPlan,this,null);
