...
public class PigGroupActor extends AbstractAFluxActor {
	private final Logger log = LoggerFactory.getLogger(this.getClass());	
	
	public PigGroupActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		String modifiers="";
		modifiers+=PigBuilder.buildCollectedClause(this.getProperty(PigConstants.COLLECTED));
		modifiers+=PigBuilder.buildParalellClause(this.getProperty(PigConstants.PARALLEL));
		
		PigBuilder.deliverPlan("group",sentence,target,log,executionPlan,this,byExpression,modifiers);
