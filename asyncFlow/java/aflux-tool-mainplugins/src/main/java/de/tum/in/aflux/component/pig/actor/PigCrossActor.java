...
public class PigCrossActor extends AbstractAFluxActor {
	private final Logger log = LoggerFactory.getLogger(this.getClass());	
	
	public PigCrossActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		String sentence=
				target+" = "+  
				"CROSS "+this.getProperty(PigConstants.ALIAS_LIST);
		sentence+=PigBuilder.buildParalellClause(this.getProperty(PigConstants.PARALLEL));
		
		PigBuilder.deliverPlan("cross",sentence,target,log,executionPlan,this,null,"");
