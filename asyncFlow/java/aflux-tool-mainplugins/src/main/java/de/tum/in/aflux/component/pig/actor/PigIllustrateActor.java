...
public class PigIllustrateActor  extends AbstractAFluxActor {
	private final Logger log = LoggerFactory.getLogger(this.getClass());	
	
	public PigIllustrateActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		String sentence="ILLUSTRATE "+alias;

		PigBuilder.deliverPlan("illustrate",sentence,alias,log,executionPlan,this);
	}
