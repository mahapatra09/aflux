...
public class HiveShowActor extends AbstractAFluxActor{
	private final Logger log = LoggerFactory.getLogger(this.getClass());	
	
	public HiveShowActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		// build sentence
		String sentence = "SHOW  ";

		sentence+=" "+this.getProperty(HiveConstants.SHOW_CLAUSE);;
		
		HiveBuilder.deliverPlan("alter",sentence,null,log,executionPlan,this,null);
