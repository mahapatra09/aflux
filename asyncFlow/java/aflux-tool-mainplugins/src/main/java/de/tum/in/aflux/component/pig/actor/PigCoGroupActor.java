...
public class PigCoGroupActor extends AbstractAFluxActor{
	private final Logger log = LoggerFactory.getLogger(this.getClass());	
	
	public PigCoGroupActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		PigBuilder.deliverPlan("cogroup",null,null,log,executionPlan,this,byExpression,null);
