...
public class PigExplainActor extends AbstractAFluxActor{
	private final Logger log = LoggerFactory.getLogger(this.getClass());	
	
	public PigExplainActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		String sentence="EXPLAIN "+alias;

		PigBuilder.deliverPlan("explain",sentence,alias,log,executionPlan,this);
	}
