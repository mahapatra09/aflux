...
public class PigSampleActor  extends AbstractAFluxActor {
	private final Logger log = LoggerFactory.getLogger(this.getClass());	
	
	public PigSampleActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		String sentence=
				target+" = "+  
				"SAMPLE "+PigBuilder.buildAlias(executionPlan,this.getProperty(PigConstants.SOURCE_ALIAS))+
				" "+this.getProperty(PigConstants.SIZE);
		
		PigBuilder.deliverPlan("sample",sentence,target,log,executionPlan,this);
