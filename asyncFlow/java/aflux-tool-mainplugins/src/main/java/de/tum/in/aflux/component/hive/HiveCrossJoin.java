...
import de.tum.in.aflux.component.hive.actor.HiveCrossJoinActor;
import de.tum.in.aflux.tools.core.AbstractMainExecutor;
import de.tum.in.aflux.tools.core.NodeLaunchType;
import de.tum.in.aflux.tools.core.PropertyInputType;
import de.tum.in.aflux.tools.core.ToolProperty;

public class HiveCrossJoin extends AbstractMainExecutor  {
	public static final String NAME="Hive CROSS JOIN";
	...
	public HiveCrossJoin() {
		super(NAME,
				HiveCrossJoinActor.class.getCanonicalName(),
				HiveCrossJoin.class.getName(),
				1, 
				1,
