...
public class PigLimitActor extends AbstractAFluxActor {
	private final Logger log = LoggerFactory.getLogger(this.getClass());	
	
	public PigLimitActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		String sentence=
				target+" = "+  
				"LIMIT "+PigBuilder.buildAlias(executionPlan,this.getProperty(PigConstants.SOURCE_ALIAS))+
				" "+this.getProperty(PigConstants.LIMIT);
		
		PigBuilder.deliverPlan("limit",sentence,target,log,executionPlan,this);
