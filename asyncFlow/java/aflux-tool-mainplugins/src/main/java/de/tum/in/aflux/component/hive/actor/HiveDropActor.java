...
public class HiveDropActor  extends AbstractAFluxActor{
	private final Logger log = LoggerFactory.getLogger(this.getClass());	
	
	public HiveDropActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		// build sentence
		String sentence = "DROP TABLE IF EXISTS ";
		String name = this.getProperty(HiveConstants.NAME);
		sentence+=" "+name;
		sentence+=HiveBuilder.buildPurgueClause(this.getProperty(HiveConstants.PURGE));
		
		HiveBuilder.deliverPlan("drop-table",sentence,name,log,executionPlan,this,null);
