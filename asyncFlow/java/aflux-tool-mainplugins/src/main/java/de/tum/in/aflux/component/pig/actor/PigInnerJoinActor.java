...
public class PigInnerJoinActor extends AbstractAFluxActor {
	private final Logger log = LoggerFactory.getLogger(this.getClass());	
	
	public PigInnerJoinActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		if (type!=null && (type.equals("replicated") || type.equals("skewed") || type.equals("merge"))) {
		...
		PigBuilder.deliverPlan("join-inner",sentence,target,log,executionPlan,this,byExpression,modifiers);
