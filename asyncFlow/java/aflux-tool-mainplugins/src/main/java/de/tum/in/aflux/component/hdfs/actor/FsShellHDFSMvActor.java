...
public class FsShellHDFSMvActor extends AbstractAFluxActor{
	public FsShellHDFSMvActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		this.getFluxEnvironment().getFsShell().mv(sourceFileName, targetFileName);
	}
