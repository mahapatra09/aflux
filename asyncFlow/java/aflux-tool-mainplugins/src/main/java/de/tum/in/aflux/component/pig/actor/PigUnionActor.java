...
public class PigUnionActor extends AbstractAFluxActor{
	private final Logger log = LoggerFactory.getLogger(this.getClass());	
	
	public PigUnionActor(String fluxId, FluxEnvironment fluxEnvironment, FluxRunner fluxRunner,Map<String,String> properties) {
	...
	protected void runCore(Object message) throws Exception {
		...
		String sentence=
				target+" = "+  
				"UNION "+this.getProperty(PigConstants.ALIAS_LIST);
		
		PigBuilder.deliverPlan("union",sentence,target,log,executionPlan,this);
